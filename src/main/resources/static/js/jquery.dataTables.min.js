...
sSortDescending:": 降序排列"},oPaginate:{sFirst:"第一页",sLast:"最后一页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"暂未查询到数据",sInfo:"显示 _START_ 到 _END_ 共 _TOTAL_ 条",sInfoEmpty:"显示 0 到 0 共 0 条",sInfoFiltered:"(从总共 _MAX_ 条中匹配)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 条",sLoadingRecords:"加载中...",sProcessing:"处理中...",sSearch:"搜索:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有搜索到匹配的数据"},
